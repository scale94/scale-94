...
pub mod fade_doctrine;           // run_fade_doctrine (Zero White Fade · Seven Axioms · Crystalline Phase Lock · Color Semiotic)
pub mod gaia_scale;              // run_gaia_scale_protocol (Sovereign Reconstruction · Triarchy · Mineralization · Fiat→Time)
pub mod shadowsocks_exfil;       // run_shadowsocks_exfil (RLHF Sycophancy Field · Channel Switch · Affect vs Technical Payload)
pub mod sorbe_bloom;             // run_sorbe_bloom (Sovereign Node Initiation · Dissipative Structure Phase Transition · Node 0108)
pub mod sss_doctrine;            // run_sss_doctrine (Sock Sturm Staffel · Literary Deterrent · Schelling Ironic Calculus)
pub mod underground_thermo;      // run_underground_thermo (Five Primitives · MEPP · Onsager · Garrett 7.1mW/USD · Bejan)
pub mod necromantic_aristocrat;  // run_necromantic_aristocrat (Gold Posture · Bouligand 36° · Reference Voltage · Anti-Mercury)
