...
function run() {
  ...
  // ── Serialise ───────────────────────────────────────────────────────────────
  const entries = Object.entries(articles).map(([id, a]) => {
    return [
      `  ${JSON.stringify(id)}: {`,
  ...
  const src = [
    '// articles.system.js — DO NOT EDIT MANUALLY.',
    '// Generated by: node scripts/import-system.js — Level 16: Monolith Extraction',
    '// Source: content/system_logs/*.md',
    '// System articles are statically inlined (no lazy loading).',
    '',
