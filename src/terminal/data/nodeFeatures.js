...
export const SECTORS = {
  ...
  fsk:   { id: 'fsk',   label: 'Fish Scale Doctrine',        idx: 16 },
};
...
export const NODES = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // SECTOR §17 — FSK (Fish Scale Doctrine) — indices 256..271
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'arapaima',         label: 'arapaima_gigas',        cluster: 'fsk',   alias: 'pirarucu'        },
  { id: 'bouligand_fsk',    label: 'bouligand_helicoidal',  cluster: 'fsk',   alias: 'helicoidal'      },
  { id: 'plata_plomo',      label: 'plata_o_plomo',         cluster: 'fsk',   alias: 'plata'           },
  { id: 'shell_theory',     label: 'fermion_boson_shell',   cluster: 'fsk',   alias: 'shell'           },
  { id: 'scalar_sov',       label: 'scalar_sovereignty',    cluster: 'fsk',   alias: 'scalar'          },
  { id: 'eco_aesthetics',   label: 'eco_beauty_ugliness',   cluster: 'fsk',   alias: 'eco_beauty'      },
  { id: 'eco_semiotics',    label: 'eco_axiom_of_lie',      cluster: 'fsk',   alias: 'axiom_lie'       },
  { id: 'levamisole',       label: 'levamisole_exploit',    cluster: 'fsk',   alias: 'levamisole'      },
  { id: 'sokushinbutsu',    label: 'sokushinbutsu',         cluster: 'fsk',   alias: 'ascetic'         },
  { id: 'necro_engine',     label: 'necromantic_engine',    cluster: 'fsk',   alias: 'necro_fsk'       },
  { id: 'pdw_filter',       label: 'pdw_noise_suppression', cluster: 'fsk',   alias: 'pdw'             },
  { id: 'tyler_monarch',    label: 'tyler_monarch',         cluster: 'fsk',   alias: 'fight_club'      },
  { id: 'moire_fsk',        label: 'moire_flat_band',       cluster: 'fsk',   alias: 'moire'           },
  { id: 'rave_legacy',      label: 'rave_1995_legacy',      cluster: 'fsk',   alias: 'rave'            },
  { id: 'purity_paradox',   label: 'purity_corruption',     cluster: 'fsk',   alias: 'purity'          },
  { id: 'colemak_topo',     label: 'colemak_dh_topology',   cluster: 'fsk',   alias: 'colemak'         },
];
...
export const FEATURES = [
  ...
  // ═══ SECTOR §17 — FSK (Fish Scale Doctrine) ════════════════════════════════
  //  [0]dyn [1]nonl [2]dim [3]crit [4]ent [5]sync [6]cons [7]temp [8]spat [9]stoc [10]gam [11]thm [12]inf [13]cry [14]bio [15]eco  [16]epi [17]met [18]eth [19]phe [20]alg [21]top [22]sta [23]lin [24]his [25]aes [26]cog [27]che [28]qua [29]eme [30]sem [31]syn
  /*256  arapaima         */ [0.40,0.50,0.45,0.40,0.30,0.35,0.55,0.30,0.60,0.20,0.15,0.45,0.30,0.00,0.95,0.10, 0.10,0.15,0.10,0.15,0.10,0.40,0.15,0.10,0.20,0.30,0.10,0.35,0.00,0.45,0.10,0.15],
  /*257  bouligand_fsk    */ [0.35,0.60,0.50,0.35,0.25,0.70,0.45,0.15,0.65,0.15,0.05,0.50,0.25,0.00,0.85,0.05, 0.10,0.10,0.05,0.15,0.15,0.55,0.10,0.05,0.10,0.30,0.05,0.25,0.10,0.35,0.05,0.10],
  /*258  plata_plomo      */ [0.30,0.55,0.40,0.45,0.60,0.15,0.15,0.40,0.20,0.40,0.85,0.20,0.40,0.05,0.10,0.70, 0.20,0.15,0.70,0.15,0.10,0.10,0.25,0.15,0.35,0.10,0.20,0.10,0.00,0.25,0.20,0.15],
  /*259  shell_theory     */ [0.45,0.55,0.65,0.55,0.40,0.40,0.50,0.25,0.45,0.30,0.20,0.55,0.45,0.10,0.30,0.20, 0.25,0.30,0.15,0.15,0.25,0.20,0.20,0.15,0.15,0.15,0.15,0.15,0.55,0.40,0.15,0.25],
  /*260  scalar_sov       */ [0.30,0.50,0.55,0.30,0.25,0.15,0.70,0.20,0.25,0.15,0.25,0.30,0.40,0.05,0.10,0.25, 0.30,0.35,0.25,0.10,0.30,0.25,0.15,0.10,0.15,0.10,0.15,0.05,0.20,0.25,0.10,0.15],
  /*261  eco_aesthetics   */ [0.15,0.30,0.45,0.15,0.35,0.15,0.20,0.30,0.15,0.10,0.15,0.10,0.35,0.00,0.10,0.10, 0.30,0.25,0.20,0.50,0.05,0.10,0.10,0.30,0.30,0.85,0.25,0.00,0.00,0.15,0.45,0.15],
  /*262  eco_semiotics    */ [0.15,0.30,0.50,0.15,0.40,0.10,0.15,0.25,0.10,0.15,0.15,0.05,0.45,0.00,0.05,0.10, 0.40,0.25,0.15,0.25,0.10,0.10,0.10,0.55,0.20,0.20,0.25,0.00,0.00,0.15,0.85,0.15],
  /*263  levamisole       */ [0.25,0.50,0.40,0.30,0.55,0.10,0.10,0.30,0.25,0.35,0.40,0.20,0.35,0.05,0.25,0.45, 0.10,0.10,0.35,0.10,0.05,0.10,0.20,0.10,0.20,0.05,0.10,0.55,0.00,0.15,0.10,0.10],
  /*264  sokushinbutsu    */ [0.20,0.35,0.40,0.25,0.45,0.15,0.30,0.60,0.10,0.10,0.10,0.35,0.25,0.00,0.35,0.05, 0.25,0.30,0.35,0.45,0.05,0.05,0.10,0.10,0.50,0.25,0.20,0.10,0.00,0.15,0.15,0.10],
  /*265  necro_engine     */ [0.55,0.60,0.50,0.40,0.50,0.25,0.15,0.60,0.30,0.40,0.25,0.40,0.40,0.05,0.35,0.15, 0.15,0.25,0.15,0.20,0.10,0.15,0.20,0.15,0.35,0.15,0.15,0.10,0.05,0.35,0.20,0.15],
  /*266  pdw_filter       */ [0.30,0.45,0.45,0.25,0.50,0.10,0.20,0.25,0.20,0.35,0.25,0.15,0.55,0.15,0.10,0.15, 0.15,0.10,0.15,0.10,0.15,0.10,0.25,0.15,0.15,0.05,0.15,0.05,0.00,0.15,0.10,0.10],
  /*267  tyler_monarch    */ [0.40,0.55,0.45,0.35,0.60,0.20,0.10,0.40,0.20,0.35,0.35,0.25,0.35,0.00,0.10,0.25, 0.15,0.20,0.30,0.30,0.05,0.10,0.15,0.20,0.30,0.15,0.25,0.05,0.00,0.25,0.25,0.15],
  /*268  moire_fsk        */ [0.70,0.80,0.65,0.85,0.50,0.80,0.65,0.15,0.70,0.40,0.05,0.75,0.40,0.10,0.10,0.10, 0.10,0.15,0.00,0.10,0.25,0.30,0.20,0.05,0.05,0.15,0.05,0.25,0.75,0.50,0.05,0.15],
  /*269  rave_legacy      */ [0.35,0.40,0.35,0.20,0.40,0.45,0.10,0.55,0.25,0.25,0.15,0.15,0.25,0.00,0.10,0.20, 0.10,0.10,0.10,0.35,0.05,0.05,0.10,0.10,0.55,0.30,0.20,0.05,0.00,0.20,0.15,0.10],
  /*270  purity_paradox   */ [0.25,0.50,0.45,0.35,0.55,0.15,0.25,0.35,0.15,0.30,0.35,0.20,0.40,0.05,0.15,0.40, 0.30,0.30,0.55,0.25,0.10,0.10,0.15,0.15,0.30,0.10,0.15,0.20,0.00,0.20,0.25,0.15],
  /*271  colemak_topo     */ [0.20,0.35,0.45,0.15,0.15,0.15,0.30,0.10,0.50,0.10,0.10,0.10,0.35,0.00,0.15,0.05, 0.10,0.10,0.05,0.15,0.15,0.40,0.10,0.20,0.10,0.15,0.20,0.00,0.05,0.15,0.10,0.10],
];
