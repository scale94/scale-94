const kernelAxioms = [
  ...
  { name: 'Crystalline', field: 'Phase', desc: 'Beyond liquid — fixed multi-dimensional structure. All transitions binary. Zero white fade. Zero entropy.' },
  { name: '7.7.7.7.7.7.7', field: 'Kernel', desc: 'Seven-fold apex: ∞-frequency genesis anchor, systemless root, sovereign non-profit node. Crystalline invariance locked.' },
];

export default kernelAxioms;
