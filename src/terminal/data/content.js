export const manifestoContent = `# /MANIFESTO
...
**Scale** is not a metric, but the ability to integrate information across orders of magnitude â€“ from the micro-processes of thought (the kernels) to the macro-structures of society (the research).
...
export const architectThesisContent = `# /ARCHITECT_THESIS
...
export const privacyContent = `# Privacy Protocol
